...
<script language="JavaScript">
	...
	function loginCheck() {
		...
		var param = "cnum" + "=" + $("#cnum").val() + "&" + "userpw" + "="
				+ $("#userpw").val();
...
<br>
	<form name="frm" id = "frm" action = "/session.do">
		...
		<table border="0" align="center" cellspacing="1" bgcolor="PapayaWhip" width="300" height="150">
			...
			<tr align="center">
				<td bgcolor="PeachPuff" width="100">학번</td>
				<td><input type="text" id="cnum" name="cnum" size="12" maxlength="12"></td>
			</tr>

			<tr align="center">
				<td bgcolor="PeachPuff">비밀번호</td>
				<td><input type="password" id="userpw" name="userpw" size="12" maxlength="12"></td>
			</tr>
